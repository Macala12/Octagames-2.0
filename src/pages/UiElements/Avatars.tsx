...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Octagames - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Octagames - React.js Tailwind CSS Admin Dashboard Template"
      />
