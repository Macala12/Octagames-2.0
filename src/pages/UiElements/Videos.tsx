...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Octagames - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Octagames - React.js Tailwind CSS Admin Dashboard Template"
      />
