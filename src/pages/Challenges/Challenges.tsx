...
export default function Challenges() {
  ...
  const [openedChallenge, setChallenge] = useState({
    id: "3",
    ...
    <div>
      ...
      <div className="p-2 dark: xl:px-10 xl:py-12">
        <div className="mx-auto w-full max-w-[630px]">
          ...
          <ChallengeList challenges={challenges} onClick={(challenge) => {
            setChallenge(challenge);
            setOpen(true);
          }} />

        <BottomSheet title="Challenge Detail" isOpen={open} onClose={() => setOpen(false)}>
            <ChallengeDetail data={openedChallenge} onBack={() => console.log("close sheet")} onPlay={() => console.log("open sheet")} />
        </BottomSheet>
        </div>
      </div>
    </div>
